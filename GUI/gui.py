...
class mainWindow(object):
    ...
    def __init__(self, master):
        ...
        helpOptions.add_command(label="Help Documentation", command=self.open_docs)
        ...
        self.save_button.grid(row=0, column=0, sticky=Tk.W, padx=15, pady=10)
        ...
        self.sort_option_menu = Tk.OptionMenu(
            master, self.sort, "Last Name", "Zip", command=self.search_query
        )
        ...
        self.book_list = Tk.Listbox(
            master, yscrollcommand=self.scrollbar.set, height=20
        )
        ...
        self.delete_button = Tk.Button(
            master, text="Delete", command=self.popup_confirmation
        )
